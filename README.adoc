...
location and directory path. These properties use Spring's http://docs.spring
.io/spring/docs/current/spring-framework-reference/html/resources.html[Resource] abstraction.
