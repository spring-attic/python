...
public class JythonWrapperTests {
	...
	public void simple() {
		...
		assertThat(jythonWrapper.sendAndRecieve("hello")).isEqualTo("HELLO");
	}

	@Test
	public void picklePage() throws IOException {
		JythonWrapper jythonWrapper = new JythonWrapper(new ClassPathResource("wrapper/page_wrapper.py"),
				shellCommandProcessor);
		Object result = jythonWrapper.sendAndRecieve(new Page());
