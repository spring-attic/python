...
public class HttpJythonWrapperConfiguration {

	@Autowired
	private JythonWrapperProperties properties;

	@Bean
	public ChannelNameAwareJythonWrapper jythonWrapper() {
		return new ChannelNameAwareJythonWrapper(properties.getScriptResource());
	}
}